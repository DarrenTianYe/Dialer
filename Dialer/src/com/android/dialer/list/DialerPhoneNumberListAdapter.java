...
public class DialerPhoneNumberListAdapter extends PhoneNumberListAdapter {
    ...
    public final static String TAG = "DialerPhoneNumberListAdapter";
    ...
    public DialerPhoneNumberListAdapter(Context context) {
        ...
        mCountryIso = PreloadUtils.getInstance().getCurrentCountryIso(context); // SPRD: Modify for performance optimization
    ...
    public void setQueryString(String queryString) {
        if(queryString == null || TextUtils.isEmpty(queryString)){
            Log.w(TAG,"queryString is null,just return!");
            return;
        }
