...
public final class CallLogQuery {
    ...
    /* SPRD: add for Universe UI @ { */
    public static final int PHONE_ID = 18;
    public static final int VIDEO_CALL_FLAG = 19;
    /** The index of the synthetic "section" column in the extended projection. */
    public static final int ICC_ID = 20;
    public static final int SECTION = 22;
    /* @} */
    public static final int CALL_MODE = 21;
}
